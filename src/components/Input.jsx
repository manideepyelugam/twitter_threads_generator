...
const Input = () => {
 ...
 function handleSelect(emotion) {
  ...
  return (
    <div className='p-4  my-16 bg-[#d9d9d98a]  rounded-[12px] w-[900px] h-[220px]'>
        <textarea
         className="w-full h-[125px] mb-1.5 p-4 rounded-[12px] placeholder:text-sm placeholder:text-start placeholder:align-top placeholder:text-black focus:outline-none"
        ...
        <div className='flex justify-between items-center mt-2'>
          ...
          onSelect={handleSelect} />
            ...
            <div>
                <button onClick={() => genrate()} className="bg-[#000] text-white text-[14px] font-normal py-2 px-4 rounded-[8px] tracking-tight ">Send</button>
            </div>
        </div>
    </div>
  )
